      ...
      <header>
        <nav className="navbar navbar-expand-lg navbar-light mynavbar px-lg-0">
          <div className="container">
            <a className="navbar-brand d-xl-none d-lg-none" href="/">
              <img src="/static/assets/images/logo.png" className="logolight" />
            </a>
                ...
                {/* <li className="nav-item header-drop ">
                         ...
                         border-dark
                          dropdown-toggle bg-transparent border-0  lh-21" aria-controls="dropdown-basic">
                                 ...
                                 <img src="/static/assets/images/country.svg" />  <span className="text-white f-14 pl-2 fw-400">US</span> <span className="caret"></span>
                              </button>
                              <ul id="dropdown-basic" className="dropdown-menu" role="menu" aria-labelledby="button-basic" style={{minWidth:"auto!important"}}>
                                 <li role="menuitem">
                                    <a className="dropdown-item text-white" href="#"> <img src="/static/assets/images/country.svg" className="pr-2" /> US</a>
                                 </li>
                                 <li role="menuitem">
                                    <a className="dropdown-item text-white" href="#"> <img src="/static/assets/images/country.svg" className="pr-2" /> US </a>
                                 </li>
